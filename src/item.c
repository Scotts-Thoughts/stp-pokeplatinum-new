...
const ItemArchiveIDs sItemArchiveIDs[] = {
    ...
    // { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x71, 0x263, 0x264, 0x0 }, // Link Cable
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    ...
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x0, 0x2C3, 0x2C4, 0x0 },
    { 0x71 + 1, 0x288, 0x289, 0x0 },
    { 0x72 + 1, 0x286, 0x287, 0x0 },
    { 0x73 + 1, 0x8C, 0x8D, 0x0 },
    { 0x74 + 1, 0x8E, 0x8F, 0x0 },
    { 0x75 + 1, 0x90, 0x91, 0x0 },
    { 0x76 + 1, 0x92, 0x93, 0x0 },
    { 0x77 + 1, 0x94, 0x95, 0x0 },
    { 0x78 + 1, 0x96, 0x97, 0x0 },
    { 0x79 + 1, 0x98, 0x99, 0x0 },
    { 0x7A + 1, 0x9A, 0x9B, 0x0 },
    { 0x7B + 1, 0x9C, 0x9D, 0x0 },
    { 0x7C + 1, 0x9E, 0x9F, 0x0 },
    { 0x7D + 1, 0xA0, 0xA1, 0x0 },
    { 0x7E + 1, 0xA2, 0xA3, 0x0 },
    { 0x7F + 1, 0xA4, 0xA5, 0x85 },
    { 0x80 + 1, 0xA6, 0xA7, 0x86 },
    { 0x81 + 1, 0xA8, 0xA9, 0x87 },
    { 0x82 + 1, 0xAA, 0xAB, 0x88 },
    { 0x83 + 1, 0xAC, 0xAD, 0x89 },
    { 0x84 + 1, 0xAE, 0xAF, 0x8A },
    { 0x85 + 1, 0xB0, 0xB1, 0x8B },
    { 0x86 + 1, 0xB2, 0xB3, 0x8C },
    { 0x87 + 1, 0xB4, 0xB5, 0x8D },
    { 0x88 + 1, 0xB6, 0xB7, 0x8E },
    { 0x89 + 1, 0xB8, 0xB9, 0x8F },
    { 0x8A + 1, 0xBA, 0xBB, 0x90 },
    { 0x8B + 1, 0xBC, 0xBD, 0x91 },
    { 0x8C + 1, 0xBE, 0xBF, 0x92 },
    { 0x8D + 1, 0xC0, 0xC1, 0x93 },
    { 0x8E + 1, 0xC2, 0xC3, 0x94 },
    { 0x8F + 1, 0xC4, 0xC5, 0x95 },
    { 0x90 + 1, 0xC6, 0xC7, 0x96 },
    { 0x91 + 1, 0xC8, 0xC9, 0x97 },
    { 0x92 + 1, 0xCA, 0xCB, 0x98 },
    { 0x93 + 1, 0xCC, 0xCD, 0x99 },
    { 0x94 + 1, 0xCE, 0xCF, 0x9A },
    { 0x95 + 1, 0xD0, 0xD1, 0x9B },
    { 0x96 + 1, 0xD2, 0xD3, 0x9C },
    { 0x97 + 1, 0xD4, 0xD5, 0x9D },
    { 0x98 + 1, 0xD6, 0xD7, 0x9E },
    { 0x99 + 1, 0xD8, 0xD9, 0x9F },
    { 0x9A + 1, 0xDA, 0xDB, 0xA0 },
    { 0x9B + 1, 0xDC, 0xDD, 0xA1 },
    { 0x9C + 1, 0xDE, 0xDF, 0xA2 },
    { 0x9D + 1, 0xE0, 0xE1, 0xA3 },
    { 0x9E + 1, 0xE2, 0xE3, 0xA4 },
    { 0x9F + 1, 0xE4, 0xE5, 0xA5 },
    { 0xA0 + 1, 0xE6, 0xE7, 0xA6 },
    { 0xA1 + 1, 0xE8, 0xE9, 0xA7 },
    { 0xA2 + 1, 0x22A, 0x22B, 0x0 },
    { 0xA3 + 1, 0x22C, 0x22D, 0x0 },
    { 0xA4 + 1, 0x22E, 0x22F, 0x0 },
    { 0xA5 + 1, 0x230, 0x231, 0x0 },
    { 0xA6 + 1, 0x232, 0x233, 0x0 },
    { 0xA7 + 1, 0x234, 0x235, 0x0 },
    { 0xA8 + 1, 0x236, 0x237, 0x0 },
    { 0xA9 + 1, 0x238, 0x239, 0x0 },
    { 0xAA + 1, 0x23A, 0x23B, 0x0 },
    { 0xAB + 1, 0x23C, 0x23D, 0x0 },
    { 0xAC + 1, 0x23E, 0x23F, 0x0 },
    { 0xAD + 1, 0x240, 0x241, 0x0 },
    { 0xAE + 1, 0x242, 0x243, 0x0 },
    { 0xAF + 1, 0x244, 0x245, 0x0 },
    { 0xB0 + 1, 0x246, 0x247, 0x0 },
    { 0xB1 + 1, 0x248, 0x249, 0x0 },
    { 0xB2 + 1, 0x24A, 0x24B, 0x0 },
    { 0xB3 + 1, 0xEA, 0xEB, 0xA8 },
    { 0xB4 + 1, 0xEC, 0xED, 0xA9 },
    { 0xB5 + 1, 0xEE, 0xEF, 0xAA },
    { 0xB6 + 1, 0xF0, 0xF1, 0xAB },
    { 0xB7 + 1, 0xF2, 0xF3, 0xAC },
    { 0xB8 + 1, 0xF4, 0xF5, 0xAD },
    { 0xB9 + 1, 0xF6, 0xF7, 0xAE },
    { 0xBA + 1, 0xF8, 0xF9, 0xAF },
    { 0xBB + 1, 0x24C, 0x24D, 0x0 },
    { 0xBC + 1, 0x24E, 0x24F, 0x0 },
    { 0xBD + 1, 0x250, 0x251, 0x0 },
    { 0xBE + 1, 0x252, 0x253, 0x0 },
    { 0xBF + 1, 0xFA, 0xFB, 0xB3 },
    { 0xC0 + 1, 0xFC, 0xFD, 0xB4 },
    { 0xC1 + 1, 0xFE, 0xFF, 0xB5 },
    { 0xC2 + 1, 0x100, 0x101, 0xB6 },
    { 0xC3 + 1, 0x102, 0x103, 0xB7 },
    { 0xC4 + 1, 0x104, 0x105, 0xB8 },
    { 0xC5 + 1, 0xFC, 0x106, 0xB9 },
    { 0xC6 + 1, 0x107, 0x108, 0xBA },
    { 0xC7 + 1, 0x109, 0x10A, 0xBB },
    { 0xC8 + 1, 0x10B, 0x10C, 0xBC },
    { 0xC9 + 1, 0x10D, 0x10E, 0xBD },
    { 0xCA + 1, 0x10F, 0x110, 0xBE },
    { 0xCB + 1, 0x111, 0x112, 0xBF },
    { 0xCC + 1, 0x113, 0x114, 0xC0 },
    { 0xCD + 1, 0x115, 0x116, 0xC1 },
    { 0xCE + 1, 0x117, 0x118, 0xC2 },
    { 0xCF + 1, 0x119, 0x11A, 0xC3 },
    { 0xD0 + 1, 0x11B, 0x11C, 0xC4 },
    { 0xD1 + 1, 0x11D, 0x11E, 0xC5 },
    { 0xD2 + 1, 0x11F, 0x120, 0xC6 },
    { 0xD3 + 1, 0x121, 0x122, 0xC7 },
    { 0xD4 + 1, 0x123, 0x124, 0xC8 },
    { 0xD5 + 1, 0x125, 0x126, 0xC9 },
    { 0xD6 + 1, 0x127, 0x128, 0xCA },
    { 0xD7 + 1, 0x129, 0x12A, 0xCB },
    { 0xD8 + 1, 0x12B, 0x12C, 0xCC },
    { 0xD9 + 1, 0x12D, 0x12E, 0xCD },
    { 0xDA + 1, 0x12F, 0x130, 0xCE },
    { 0xDB + 1, 0x131, 0x130, 0xCF },
    { 0xDC + 1, 0x132, 0x133, 0xD0 },
    { 0xDD + 1, 0x134, 0x135, 0xD1 },
    { 0xDE + 1, 0x136, 0x137, 0xD2 },
    { 0xDF + 1, 0x138, 0x139, 0xD3 },
    { 0xE0 + 1, 0x13A, 0x13B, 0xD4 },
    { 0xE1 + 1, 0x13C, 0x13D, 0xD5 },
    { 0xE2 + 1, 0x13E, 0x13F, 0xD6 },
    { 0xE3 + 1, 0x140, 0x141, 0xD7 },
    { 0xE4 + 1, 0x142, 0x143, 0xD8 },
    { 0xE5 + 1, 0x144, 0x145, 0xD9 },
    { 0xE6 + 1, 0x146, 0x147, 0xDA },
    { 0xE7 + 1, 0x148, 0x4D, 0xDB },
    { 0xE8 + 1, 0x149, 0x14A, 0xDC },
    { 0xE9 + 1, 0x14B, 0x14C, 0xDD },
    { 0xEA + 1, 0x14D, 0x14E, 0xDE },
    { 0xEB + 1, 0x14F, 0x150, 0xDF },
    { 0xEC + 1, 0x151, 0x152, 0xE0 },
    { 0xED + 1, 0x153, 0x154, 0xE1 },
    { 0xEE + 1, 0x155, 0x156, 0xFE },
    { 0xEF + 1, 0x155, 0x157, 0xFF },
    { 0xF0 + 1, 0x155, 0x158, 0x100 },
    { 0xF1 + 1, 0x155, 0x159, 0x101 },
    { 0xF2 + 1, 0x155, 0x15A, 0x102 },
    { 0xF3 + 1, 0x1EA, 0x1EB, 0x0 },
    { 0xF4 + 1, 0x1EC, 0x1ED, 0x0 },
    { 0xF5 + 1, 0x1EE, 0x1EF, 0x0 },
    { 0xF6 + 1, 0x1F0, 0x1F1, 0x0 },
    { 0xF7 + 1, 0x263, 0x264, 0x0 },
    { 0xF8 + 1, 0x1F2, 0x1F3, 0x0 },
    { 0xF9 + 1, 0x1F4, 0x1F5, 0x0 },
    { 0xFA + 1, 0x1F6, 0x1F7, 0x0 },
    { 0xFB + 1, 0x1F8, 0x1F9, 0x0 },
    { 0xFC + 1, 0x14F, 0x292, 0x0 },
    { 0xFD + 1, 0x293, 0x294, 0x0 },
    { 0xFE + 1, 0x1FA, 0x1FB, 0x0 },
    { 0xFF + 1, 0x1FC, 0x1FD, 0x0 },
    { 0x100 + 1, 0x265, 0x266, 0x0 },
    { 0x101 + 1, 0x28A, 0x28B, 0x0 },
    { 0x102 + 1, 0x28E, 0x28F, 0x0 },
    { 0x103 + 1, 0x1FE, 0x1FF, 0x0 },
    { 0x104 + 1, 0x27C, 0x27D, 0x0 },
    { 0x105 + 1, 0x27E, 0x27F, 0x0 },
    { 0x106 + 1, 0x280, 0x281, 0x0 },
    { 0x107 + 1, 0x282, 0x283, 0x0 },
    { 0x108 + 1, 0x28C, 0x28D, 0x0 },
    { 0x109 + 1, 0x200, 0x201, 0x0 },
    { 0x10A + 1, 0x202, 0x203, 0x0 },
    { 0x10B + 1, 0x2AB, 0x2AC, 0x0 },
    { 0x10C + 1, 0x2B3, 0x2B4, 0x0 },
    { 0x10D + 1, 0x2B5, 0x2B6, 0x0 },
    { 0x10E + 1, 0x2AD, 0x2AE, 0x0 },
    { 0x10F + 1, 0x2AF, 0x2B0, 0x0 },
    { 0x110 + 1, 0x2B1, 0x2B2, 0x0 },
    { 0x111 + 1, 0x204, 0x205, 0x0 },
    { 0x112 + 1, 0x206, 0x207, 0x0 },
    { 0x113 + 1, 0x208, 0x209, 0x0 },
    { 0x114 + 1, 0x26B, 0x26C, 0x0 },
    { 0x115 + 1, 0x26B, 0x26D, 0x0 },
    { 0x116 + 1, 0x26B, 0x26E, 0x0 },
    { 0x117 + 1, 0x26B, 0x26F, 0x0 },
    { 0x118 + 1, 0x26B, 0x270, 0x0 },
    { 0x119 + 1, 0x26B, 0x271, 0x0 },
    { 0x11A + 1, 0x26B, 0x272, 0x0 },
    { 0x11B + 1, 0x26B, 0x273, 0x0 },
    { 0x11C + 1, 0x26B, 0x274, 0x0 },
    { 0x11D + 1, 0x26B, 0x275, 0x0 },
    { 0x11E + 1, 0x26B, 0x276, 0x0 },
    { 0x11F + 1, 0x26B, 0x277, 0x0 },
    { 0x120 + 1, 0x26B, 0x278, 0x0 },
    { 0x121 + 1, 0x26B, 0x279, 0x0 },
    { 0x122 + 1, 0x26B, 0x27A, 0x0 },
    { 0x123 + 1, 0x26B, 0x27B, 0x0 },
    { 0x124 + 1, 0x20A, 0x20B, 0x0 },
    { 0x125 + 1, 0x20C, 0x20D, 0x0 },
    { 0x126 + 1, 0x20E, 0x20F, 0x0 },
    { 0x127 + 1, 0x210, 0x211, 0x0 },
    { 0x128 + 1, 0x212, 0x213, 0x0 },
    { 0x129 + 1, 0x214, 0x215, 0x0 },
    { 0x12A + 1, 0x216, 0x217, 0x0 },
    { 0x12B + 1, 0x2B7, 0x2B8, 0x0 },
    { 0x12C + 1, 0x218, 0x219, 0x0 },
    { 0x12D + 1, 0x21A, 0x21B, 0x0 },
    { 0x12E + 1, 0x21C, 0x21D, 0x0 },
    { 0x12F + 1, 0x21E, 0x21F, 0x0 },
    { 0x130 + 1, 0x220, 0x221, 0x0 },
    { 0x131 + 1, 0x222, 0x223, 0x0 },
    { 0x132 + 1, 0x18D, 0x18E, 0x121 },
    { 0x133 + 1, 0x18D, 0x18F, 0x122 },
    { 0x134 + 1, 0x18D, 0x190, 0x123 },
    { 0x135 + 1, 0x18D, 0x191, 0x124 },
    { 0x136 + 1, 0x18D, 0x192, 0x125 },
    { 0x137 + 1, 0x18D, 0x193, 0x126 },
    { 0x138 + 1, 0x18D, 0x194, 0x127 },
    { 0x139 + 1, 0x18D, 0x18E, 0x128 },
    { 0x13A + 1, 0x18D, 0x195, 0x129 },
    { 0x13B + 1, 0x18D, 0x192, 0x12A },
    { 0x13C + 1, 0x18D, 0x196, 0x12B },
    { 0x13D + 1, 0x18D, 0x197, 0x12C },
    { 0x13E + 1, 0x18D, 0x194, 0x12D },
    { 0x13F + 1, 0x18D, 0x194, 0x12E },
    { 0x140 + 1, 0x18D, 0x192, 0x12F },
    { 0x141 + 1, 0x18D, 0x191, 0x130 },
    { 0x142 + 1, 0x18D, 0x192, 0x131 },
    { 0x143 + 1, 0x18D, 0x190, 0x132 },
    { 0x144 + 1, 0x18D, 0x195, 0x133 },
    { 0x145 + 1, 0x18D, 0x192, 0x134 },
    { 0x146 + 1, 0x18D, 0x192, 0x135 },
    { 0x147 + 1, 0x18D, 0x195, 0x136 },
    { 0x148 + 1, 0x18D, 0x198, 0x137 },
    { 0x149 + 1, 0x18D, 0x199, 0x138 },
    { 0x14A + 1, 0x18D, 0x199, 0x139 },
    { 0x14B + 1, 0x18D, 0x19A, 0x13A },
    { 0x14C + 1, 0x18D, 0x192, 0x13B },
    { 0x14D + 1, 0x18D, 0x19A, 0x13C },
    { 0x14E + 1, 0x18D, 0x191, 0x13D },
    { 0x14F + 1, 0x18D, 0x19B, 0x13E },
    { 0x150 + 1, 0x18D, 0x18E, 0x13F },
    { 0x151 + 1, 0x18D, 0x192, 0x140 },
    { 0x152 + 1, 0x18D, 0x191, 0x141 },
    { 0x153 + 1, 0x18D, 0x199, 0x142 },
    { 0x154 + 1, 0x18D, 0x196, 0x143 },
    { 0x155 + 1, 0x18D, 0x193, 0x144 },
    { 0x156 + 1, 0x18D, 0x19C, 0x145 },
    { 0x157 + 1, 0x18D, 0x196, 0x146 },
    { 0x158 + 1, 0x18D, 0x19C, 0x147 },
    { 0x159 + 1, 0x18D, 0x19D, 0x148 },
    { 0x15A + 1, 0x18D, 0x197, 0x149 },
    { 0x15B + 1, 0x18D, 0x192, 0x14A },
    { 0x15C + 1, 0x18D, 0x192, 0x14B },
    { 0x15D + 1, 0x18D, 0x191, 0x14C },
    { 0x15E + 1, 0x18D, 0x192, 0x14D },
    { 0x15F + 1, 0x18D, 0x197, 0x14E },
    { 0x160 + 1, 0x18D, 0x198, 0x14F },
    { 0x161 + 1, 0x18D, 0x191, 0x150 },
    { 0x162 + 1, 0x18D, 0x197, 0x151 },
    { 0x163 + 1, 0x18D, 0x196, 0x152 },
    { 0x164 + 1, 0x18D, 0x19D, 0x0 },
    { 0x165 + 1, 0x18D, 0x18E, 0x0 },
    { 0x166 + 1, 0x18D, 0x195, 0x0 },
    { 0x167 + 1, 0x18D, 0x192, 0x0 },
    { 0x168 + 1, 0x18D, 0x190, 0x0 },
    { 0x169 + 1, 0x18D, 0x197, 0x0 },
    { 0x16A + 1, 0x18D, 0x199, 0x0 },
    { 0x16B + 1, 0x18D, 0x192, 0x0 },
    { 0x16C + 1, 0x18D, 0x18F, 0x0 },
    { 0x16D + 1, 0x18D, 0x18E, 0x0 },
    { 0x16E + 1, 0x18D, 0x196, 0x0 },
    { 0x16F + 1, 0x18D, 0x262, 0x0 },
    { 0x170 + 1, 0x18D, 0x197, 0x0 },
    { 0x171 + 1, 0x18D, 0x192, 0x0 },
    { 0x172 + 1, 0x18D, 0x19B, 0x0 },
    { 0x173 + 1, 0x18D, 0x197, 0x0 },
    { 0x174 + 1, 0x18D, 0x192, 0x0 },
    { 0x175 + 1, 0x18D, 0x192, 0x0 },
    { 0x176 + 1, 0x18D, 0x19C, 0x0 },
    { 0x177 + 1, 0x18D, 0x192, 0x0 },
    { 0x178 + 1, 0x18D, 0x19C, 0x0 },
    { 0x179 + 1, 0x18D, 0x194, 0x0 },
    { 0x17A + 1, 0x18D, 0x199, 0x0 },
    { 0x17B + 1, 0x18D, 0x198, 0x0 },
    { 0x17C + 1, 0x18D, 0x192, 0x0 },
    { 0x17D + 1, 0x18D, 0x19C, 0x0 },
    { 0x17E + 1, 0x18D, 0x192, 0x0 },
    { 0x17F + 1, 0x18D, 0x192, 0x0 },
    { 0x180 + 1, 0x18D, 0x197, 0x0 },
    { 0x181 + 1, 0x18D, 0x19C, 0x0 },
    { 0x182 + 1, 0x18D, 0x262, 0x0 },
    { 0x183 + 1, 0x18D, 0x192, 0x0 },
    { 0x184 + 1, 0x18D, 0x192, 0x0 },
    { 0x185 + 1, 0x18D, 0x193, 0x0 },
    { 0x186 + 1, 0x18D, 0x191, 0x0 },
    { 0x187 + 1, 0x18D, 0x195, 0x0 },
    { 0x188 + 1, 0x18D, 0x192, 0x0 },
    { 0x189 + 1, 0x18D, 0x19D, 0x0 },
    { 0x18A + 1, 0x18D, 0x262, 0x0 },
    { 0x18B + 1, 0x18D, 0x192, 0x0 },
    { 0x18C + 1, 0x18D, 0x198, 0x0 },
    { 0x18D + 1, 0x18D, 0x191, 0x0 },
    { 0x18E + 1, 0x19E, 0x192, 0x153 },
    { 0x18F + 1, 0x19E, 0x19D, 0x154 },
    { 0x190 + 1, 0x19E, 0x190, 0x155 },
    { 0x191 + 1, 0x19E, 0x192, 0x156 },
    { 0x192 + 1, 0x19E, 0x190, 0x157 },
    { 0x193 + 1, 0x19E, 0x18E, 0x158 },
    { 0x194 + 1, 0x19E, 0x190, 0x159 },
    { 0x195 + 1, 0x19E, 0x192, 0x15A },
    { 0x196 + 1, 0x224, 0x225, 0x0 },
    { 0x197 + 1, 0x226, 0x227, 0x0 },
    { 0x198 + 1, 0x228, 0x229, 0x0 },
    { 0x199 + 1, 0x2B9, 0x2BA, 0x0 },
    { 0x19A + 1, 0x2A9, 0x2AA, 0x0 },
    { 0x19B + 1, 0x25E, 0x25F, 0x0 },
    { 0x19C + 1, 0x29F, 0x2A0, 0x0 },
    { 0x19D + 1, 0x2A3, 0x2A4, 0x0 },
    { 0x19E + 1, 0x2A1, 0x2A2, 0x0 },
    { 0x19F + 1, 0x295, 0x296, 0x0 },
    { 0x1A0 + 1, 0x284, 0x285, 0x0 },
    { 0x1A1 + 1, 0x25C, 0x25D, 0x0 },
    { 0x1A2 + 1, 0x290, 0x291, 0x0 },
    { 0x1A3 + 1, 0x2A7, 0x2A8, 0x0 },
    { 0x1A4 + 1, 0x1B7, 0x1B8, 0x169 },
    { 0x1A5 + 1, 0x1B9, 0x1BA, 0x16A },
    { 0x1A6 + 1, 0x15D, 0x15E, 0x104 },
    { 0x1A7 + 1, 0x161, 0x162, 0x106 },
    { 0x1A8 + 1, 0x163, 0x164, 0x107 },
    { 0x1A9 + 1, 0x165, 0x166, 0x108 },
    { 0x1AA + 1, 0x16B, 0x16C, 0x0 },
    { 0x1AB + 1, 0x175, 0x176, 0x0 },
    { 0x1AC + 1, 0x1B5, 0x1B6, 0x168 },
    { 0x1AD + 1, 0x1AD, 0x1AE, 0x0 },
    { 0x1AE + 1, 0x177, 0x40, 0x0 },
    { 0x1AF + 1, 0x25A, 0x25B, 0x0 },
    { 0x1B0 + 1, 0x260, 0x261, 0x0 },
    { 0x1B1 + 1, 0x2A5, 0x2A6, 0x0 },
    { 0x1B2 + 1, 0x167, 0x168, 0x109 },
    { 0x1B3 + 1, 0x169, 0x16A, 0x10A },
    { 0x1B4 + 1, 0x254, 0x255, 0x0 },
    { 0x1B5 + 1, 0x19F, 0x1A0, 0x15D },
    { 0x1B6 + 1, 0x1A1, 0x1A2, 0x0 },
    { 0x1B7 + 1, 0x1A3, 0x1A4, 0x0 },
    { 0x1B8 + 1, 0x1A5, 0x1A6, 0x0 },
    { 0x1B9 + 1, 0x256, 0x257, 0x11D },
    { 0x1BA + 1, 0x258, 0x259, 0x0 },
    { 0x1BB + 1, 0x2BD, 0x2BE, 0x0 },
    { 0x1BC + 1, 0x2BF, 0x2C0, 0x0 },
    { 0x1BD + 1, 0x2C1, 0x2C2, 0x15F }
};
